...
const (
	DoguAdministration_GetDoguList_FullMethodName    = "/doguAdministration.DoguAdministration/GetDoguList"
	DoguAdministration_GetBlueprintId_FullMethodName = "/doguAdministration.DoguAdministration/GetBlueprintId"
	DoguAdministration_StartDogu_FullMethodName      = "/doguAdministration.DoguAdministration/StartDogu"
	DoguAdministration_StopDogu_FullMethodName       = "/doguAdministration.DoguAdministration/StopDogu"
	DoguAdministration_RestartDogu_FullMethodName    = "/doguAdministration.DoguAdministration/RestartDogu"
)
...
func (c *doguAdministrationClient) GetDoguList(ctx context.Context, in *DoguListRequest, opts ...grpc.CallOption) (*DoguListResponse, error) {
	...
	err := c.cc.Invoke(ctx, DoguAdministration_GetDoguList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *doguAdministrationClient) GetBlueprintId(ctx context.Context, in *DoguBlueprinitIdRequest, opts ...grpc.CallOption) (*DoguBlueprintIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, DoguAdministration_GetBlueprintId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *doguAdministrationClient) StartDogu(ctx context.Context, in *DoguAdministrationRequest, opts ...grpc.CallOption) (*types.BasicResponse, error) {
	...
	err := c.cc.Invoke(ctx, DoguAdministration_StartDogu_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *doguAdministrationClient) StopDogu(ctx context.Context, in *DoguAdministrationRequest, opts ...grpc.CallOption) (*types.BasicResponse, error) {
	out := new(types.BasicResponse)
	err := c.cc.Invoke(ctx, DoguAdministration_StopDogu_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *doguAdministrationClient) RestartDogu(ctx context.Context, in *DoguAdministrationRequest, opts ...grpc.CallOption) (*types.BasicResponse, error) {
	out := new(types.BasicResponse)
	err := c.cc.Invoke(ctx, DoguAdministration_RestartDogu_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DoguAdministration_GetDoguList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DoguAdministration_GetDoguList_FullMethodName,
	}
...
func _DoguAdministration_GetBlueprintId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DoguAdministration_GetBlueprintId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DoguAdministration_StartDogu_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DoguAdministration_StartDogu_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DoguAdministration_StopDogu_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DoguAdministration_StopDogu_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DoguAdministration_RestartDogu_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DoguAdministration_RestartDogu_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var DoguAdministration_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "dogu_administration.proto",
}
