...
var file_response_proto_rawDesc = []byte{
	...
	0x12, 0x05, 0x74, 0x79, 0x70, 0x65, 0x73, 0x22, 0x0f, 0x0a, 0x0d, 0x42, 0x61, 0x73, 0x69, 0x63,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x29, 0x0a, 0x13, 0x43, 0x68, 0x75, 0x6e,
	0x6b, 0x65, 0x64, 0x44, 0x61, 0x74, 0x61, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	...
	0x61, 0x74, 0x65, 0x64, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_response_proto_goTypes = []interface{}{
	(*BasicResponse)(nil),       // 0: types.BasicResponse
	(*ChunkedDataResponse)(nil), // 1: types.ChunkedDataResponse
}
...
func file_response_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_response_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ChunkedDataResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
