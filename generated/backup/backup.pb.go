...
var file_backup_proto_rawDesc = []byte{
	...
	0x75, 0x65, 0x73, 0x74, 0x22, 0xad, 0x01, 0x0a, 0x0e, 0x42, 0x61, 0x63, 0x6b, 0x75, 0x70, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x74, 0x61, 0x72, 0x74,
	...
	0x73, 0x61, 0x67, 0x65, 0x22, 0x1e, 0x0a, 0x1c, 0x52, 0x65, 0x73, 0x74, 0x69, 0x63, 0x43, 0x72,
	...
	0x05, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x32, 0x87, 0x02, 0x0a, 0x10, 0x42, 0x61, 0x63, 0x6b, 0x75,
...
var file_backup_proto_goTypes = []interface{}{
	...
	(*BackupResponse)(nil),               // 3: backup.BackupResponse
	(*ResticCredentialValidRequest)(nil), // 4: backup.ResticCredentialValidRequest
	(*ResticCredentialResponse)(nil),     // 5: backup.ResticCredentialResponse
}
var file_backup_proto_depIdxs = []int32{
	2, // 0: backup.BackupManagement.LastSuccessful:input_type -> backup.LastSuccessfulBackupRequest
	4, // 1: backup.BackupManagement.ResticCredValid:input_type -> backup.ResticCredentialValidRequest
	0, // 2: backup.BackupManagement.CreateBackup:input_type -> backup.CreateBackupRequest
	3, // 3: backup.BackupManagement.LastSuccessful:output_type -> backup.BackupResponse
	5, // 4: backup.BackupManagement.ResticCredValid:output_type -> backup.ResticCredentialResponse
	1, // 5: backup.BackupManagement.CreateBackup:output_type -> backup.CreateBackupResponse
