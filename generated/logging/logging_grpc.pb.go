...
const (
	DoguLogMessages_GetForDogu_FullMethodName               = "/logging.DoguLogMessages/GetForDogu"
	DoguLogMessages_QueryForDogu_FullMethodName             = "/logging.DoguLogMessages/QueryForDogu"
	DoguLogMessages_ApplyLogLevelWithRestart_FullMethodName = "/logging.DoguLogMessages/ApplyLogLevelWithRestart"
)
...
func (c *doguLogMessagesClient) GetForDogu(ctx context.Context, in *DoguLogMessageRequest, opts ...grpc.CallOption) (DoguLogMessages_GetForDoguClient, error) {
	stream, err := c.cc.NewStream(ctx, &DoguLogMessages_ServiceDesc.Streams[0], DoguLogMessages_GetForDogu_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *doguLogMessagesClient) QueryForDogu(ctx context.Context, in *DoguLogMessageQueryRequest, opts ...grpc.CallOption) (DoguLogMessages_QueryForDoguClient, error) {
	stream, err := c.cc.NewStream(ctx, &DoguLogMessages_ServiceDesc.Streams[1], DoguLogMessages_QueryForDogu_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *doguLogMessagesClient) ApplyLogLevelWithRestart(ctx context.Context, in *LogLevelRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, DoguLogMessages_ApplyLogLevelWithRestart_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DoguLogMessages_ApplyLogLevelWithRestart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DoguLogMessages_ApplyLogLevelWithRestart_FullMethodName,
	}
