...
const (
	SupportArchive_Create_FullMethodName = "/maintenance.SupportArchive/Create"
)
...
func (c *supportArchiveClient) Create(ctx context.Context, in *CreateSupportArchiveRequest, opts ...grpc.CallOption) (SupportArchive_CreateClient, error) {
	stream, err := c.cc.NewStream(ctx, &SupportArchive_ServiceDesc.Streams[0], SupportArchive_Create_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
