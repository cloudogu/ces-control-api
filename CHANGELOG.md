...
## [Unreleased]
### Added
- [#35] added Category to Dogu response objects

## [v1.9.0] - 2026-09-10
- [#32] add errormessage to debugmode response

## [v1.8.0] - 2026-05-21
### Added
- [#27] added API for backup timeout

## [v1.7.0] - 2025-12-17
### Changed
- [#27] extend support archive api for multinode
